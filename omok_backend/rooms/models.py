...
class Room(models.Model):
    player1 = models.ForeignKey('auth.User', null=True, related_name='player1',on_delete=models.CASCADE)
    player2 = models.ForeignKey('auth.User', null=True, related_name='player2',on_delete=models.CASCADE)
